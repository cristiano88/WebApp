...
var myESP32 = '7e400001-b5a3-f393-e0a9-e50e24dcca9e'

var otaServiceUuid = '7e400001-b5a3-f393-e0a9-e50e24dcca9e'

var fwCharacteristicUuid = '7e400010-b5a3-f393-e0a9-e50e24dcca9e'

var hwCharacteristicUuid = '7e400011-b5a3-f393-e0a9-e50e24dcca9e'
...
function CheckVersion(){
  ...
  return esp32Service.getCharacteristic(hwCharacteristicUuid)
  ...
  .then(_ => fetch('https://raw.githubusercontent.com/cristiano88/resf_fw/main/version.json'))
  ...
  .then(function (data) {
    ...
    if (latestCompatibleSoftware === softwareVersion)
    {
      ...
      console.log(latestCompatibleSoftware);
      console.log("Software is updated, do nothing");
    }
    else {
    ...
    Popup.create({
      ...
      buttons: {
          left: [{
              text: 'Yes',
              action: function () {
                fetch('https://raw.githubusercontent.com/cristiano88/resf_fw/main/firmware.bin')
                .then(function (response) {
...
function SendFileOverBluetooth() {
  ...
  amountToWrite = 0;
  currentPosition = 0;
  esp32Service.getCharacteristic(fwCharacteristicUuid)
  .then(characteristic => {
